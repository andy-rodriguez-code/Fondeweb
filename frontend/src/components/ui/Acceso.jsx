...
export default function Acceso({ href, icono, titulo, className = '', children, ...rest }) {
  const clases =
  ...
  return (
    <a href={href} className={clases} {...rest}>
      <span className="acceso__icono w-[42px] h-[42px] grid place-items-center rounded-sm bg-interactive/20 text-interactive-bright">
